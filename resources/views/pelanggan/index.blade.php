    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                {{-- <div class="col-sm-6"> --}}
                <div class="logo">
                    <h1><a href="./"><img src="assets/img/frioburrito2.png" style="width:176px; height:75px;"></a>
                    </h1>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        {{-- <li><a href="shop.html" >Kategori</a></li> --}}
                        <li class="dropdown dropdown-small">
                            <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span
                                    class="key">Kategori</span></a>
                            <ul class="dropdown-menu">
                                <li class="active"><a href="#">Burrito Kentang</a></li>
                                <li class="active"><a href="#">Burrito Ubi</a></li>
                            </ul>
                        </li>
                        <li><a href="single-product.html">Keranjang</a></li>
    ...
    <div class="slider-area">
        ...
        <div class="block-slider block-slider4">
            <ul class="" id="bxslider-home4">
                <li>
                    <img src="assets/img/burritokentangbowl.png" alt="Slide">
                    <div class="caption-group">
                        <span class="primary"></span>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
                    </div>
                </li>
                <li><img src="assets/img/burritokentangkulit.png" alt="Slide">
                    <div class="caption-group">
                        <span class="primary"></span>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
                    </div>
                </li>
                <li><img src="assets/img/burritokentangtelorkulit.png" alt="Slide">
                    <div class="caption-group">
                        <span class="primary"></span>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
                    </div>
                </li>
                <li><img src="assets/img/burritoubikulitkejutelur.png" alt="Slide">
                    <div class="caption-group">
                        <span class="primary"></span>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
                    </div>
